const CACHE = "abvm-grade2-parent-companion-v27";
const SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  ...
  "./assets/calendar/music.svg",
  "./assets/calendar/computer.svg",
  "./assets/calendar/library.svg",
  "./assets/calendar/guidance.svg",
  "./assets/calendar/school-event.svg",
